...
export type CategoryAction = FetchCategoryStart | FetchCategorySuccess | FetchCategoryFail;

export const fetchCategoriesStart = withMatcher((): FetchCategoryStart => (
  createAction(CATEGORIES_ACTION_TYPES.FETCH_CATEGORIES_START)
))

export const fetchCategoriesSuccess = withMatcher((categoriesArray: Category[]): FetchCategorySuccess => (
  createAction(CATEGORIES_ACTION_TYPES.FETCH_CATEGORIES_SUCCESS, categoriesArray)
))

export const fetchCategoriesFail = withMatcher((error: Error): FetchCategoryFail => (
